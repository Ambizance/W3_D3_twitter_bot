...
#     short_list = journalist_list.sample(5)
...
# def send_message(client, list)
#     list.each { |handler| client.update(" #bonjour_monde, bonjour #{handler}, si vous voyez ce tweet, c'est que mon appli à fonctionnée ! :) ") }
# end
...
# send_message(client, five_random)
# end
